...
import 'package:woke_out/screens/today_exercises_page.dart';
...
class _TodayPageState extends State<TodayPage> {
  ...
  Widget build(BuildContext context) {
    return showChooseExercise
        ? chooseExercisePage(context)
        : todayExercisePage(context);
  }

  Widget chooseExercisePage(BuildContext context) => Scaffold(
        body: Container(
  ...
  Widget todayExercisePage(BuildContext context) => Container();
}
