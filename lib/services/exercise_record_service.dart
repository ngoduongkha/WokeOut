...
class ExerciseRecordService{
  ...
  Future<dynamic> getAllRecordDates() async{
    return recordRef
        ...
        .then(
            ...
            snapshot
                .docs
                .map((doc)=> DateTime.fromMillisecondsSinceEpoch(doc.data()['timeStamp'].seconds*1000))
                .toList()
    );
  }
  ...
  bool isSameDate(Timestamp time, DateTime targetDate){
    ...
    if(targetDate.day == recordDate.day
        ...
        targetDate.year == recordDate.year) return true;
    else return false;
  }
  bool isSameMonth(Timestamp time, DateTime targetDate){
    var recordDate = DateTime.fromMillisecondsSinceEpoch(time.seconds*1000);
    if(recordDate.month == targetDate.month && recordDate.year == targetDate.year) return true;
    else return false;
  }
